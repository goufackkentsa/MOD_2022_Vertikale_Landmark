...
img = cv2.imread('images/train/vertikale_landmark_5.tif')
...
labeled_img = cv2.imread('images/label/mask_5.tif')
...
plt.imsave('segmented_landmark_8.jpg', segmented, cmap='jet')