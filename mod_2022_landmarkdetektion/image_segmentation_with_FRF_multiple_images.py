...
mask_dataset = mask_dataset.reset_index(drop=True)
print(image_dataset)
print(mask_dataset)

#dataset = pd.merge(image_dataset, mask_dataset, how='inner')
#print(dataset)
dataset = pd.concat([image_dataset, mask_dataset], axis=1, join='inner')  # Concatenate both image and mask datasets
...
model_name = "landmark_RF_multi_image"
